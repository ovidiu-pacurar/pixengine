  ...
  game.tools = {
    draw:{
      ...
      point: function(px,py,r){  	  
        ...
        game.space.set(px,py,game.material.id);
	...
	drawRectangle:{
      icon: 'img/tool-rectangle.png',
      tip:'draw rectangle',
      point: function(px,py,r){  	  	        
	  },
	  line: function(x1,y1,x2,y2,r){
		  game.actions.drawRectangle(x1,y1,x2,y2,r,game.material.id);
	  }
	},
	drawCircle:{
      icon: 'img/tool-circle.png',
      tip:'draw circle',
      point: function(px,py,r){  	  	        
	  },
	  line: function(x1,y1,x2,y2,r){
		  game.actions.drawCircle(x1,y1,x2,y2,r,game.material.id);
	  }
	},
	 erase:{    
